...
- [Frontend Architecture](/docs/architecture/frontend-architecture) - Understand the Next.js structure
- [Backend Architecture](/docs/architecture/backend-architecture) - Explore API route implementation
- [Database Schema](/docs/architecture/database-schema) - Learn the data model
- [API Reference](/docs/api-reference/introduction) - Test API endpoints
